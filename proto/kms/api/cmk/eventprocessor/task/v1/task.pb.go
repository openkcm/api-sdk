...
const file_kms_api_cmk_eventprocessor_task_v1_task_proto_rawDesc = "" +
	...
	"\n" +
	"cmk_region\x18< \x01(\tR\tcmkRegion*\x99\x01\n" +
	"\bTaskType\x12\x0e\n" +
	"\n" +
	"KEY_ENABLE\x10\x00\x12\x0f\n" +
	"\vKEY_DISABLE\x10\x01\x12\x0e\n" +
	"\n" +
	"KEY_DELETE\x10\x02\x12\x15\n" +
	"\x11SYSTEM_KEY_ROTATE\x10\x03\x12\x0f\n" +
	"\vSYSTEM_LINK\x10\x04\x12\x11\n" +
	"\rSYSTEM_UNLINK\x10\x05\x12\x11\n" +
	"\rSYSTEM_SWITCH\x10\x06\x12\x0e\n" +
	"\n" +
	"KEY_DETACH\x10\aBLZJgithub.com/openkcm/api-sdk/proto/kms/api/cmk/eventprocessor/task/v1;taskv1b\x06proto3"
