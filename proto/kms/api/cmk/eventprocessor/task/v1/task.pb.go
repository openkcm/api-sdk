...
type Data struct {
	...
	TaskType TaskType               `protobuf:"varint,5,opt,name=task_type,json=taskType,proto3,enum=kms.api.cmk.eventprocessor.task.v1.TaskType" json:"task_type,omitempty"`
	// Types that are valid to be assigned to Data:
	//
	//	*Data_KeyAction
	//	*Data_SystemAction
	//	*Data_TenantConfigAction
...
func (x *Data) GetTenantConfigAction() *TenantConfigAction {
	if x != nil {
		if x, ok := x.Data.(*Data_TenantConfigAction); ok {
			return x.TenantConfigAction
		}
	}
	return nil
}
...
type Data_TenantConfigAction struct {
	TenantConfigAction *TenantConfigAction `protobuf:"bytes,30,opt,name=tenant_config_action,json=tenantConfigAction,proto3,oneof"`
}
...
func (*Data_TenantConfigAction) isData_Data() {}
...
// TaskType TENANT_RECONFIGURE
type TenantConfigAction struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *TenantConfigAction) Reset() {
	*x = TenantConfigAction{}
	mi := &file_kms_api_cmk_eventprocessor_task_v1_task_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TenantConfigAction) ProtoMessage() {}

func (x *TenantConfigAction) ProtoReflect() protoreflect.Message {
	mi := &file_kms_api_cmk_eventprocessor_task_v1_task_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TenantConfigAction.ProtoReflect.Descriptor instead.
func (*TenantConfigAction) Descriptor() ([]byte, []int) {
	return file_kms_api_cmk_eventprocessor_task_v1_task_proto_rawDescGZIP(), []int{3}
}

func (x *TenantConfigAction) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
const file_kms_api_cmk_eventprocessor_task_v1_task_proto_rawDesc = "" +
	"\n" +
	"-kms/api/cmk/eventprocessor/task/v1/task.proto\x12\"kms.api.cmk.eventprocessor.task.v1\"\xee\x02\n" +
	"\x04Data\x12I\n" +
	...
	"\rsystem_action\x18\x14 \x01(\v20.kms.api.cmk.eventprocessor.task.v1.SystemActionH\x00R\fsystemAction\x12j\n" +
	"\x14tenant_config_action\x18\x1e \x01(\v26.kms.api.cmk.eventprocessor.task.v1.TenantConfigActionH\x00R\x12tenantConfigActionB\x06\n" +
	"\x04data\"^\n" +
	"\tKeyAction\x12\x15\n" +
	"\x06key_id\x18\n" +
...
var file_kms_api_cmk_eventprocessor_task_v1_task_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_kms_api_cmk_eventprocessor_task_v1_task_proto_goTypes = []any{
	...
	(*TenantConfigAction)(nil), // 4: kms.api.cmk.eventprocessor.task.v1.TenantConfigAction
}
var file_kms_api_cmk_eventprocessor_task_v1_task_proto_depIdxs = []int32{
	...
	4, // 3: kms.api.cmk.eventprocessor.task.v1.Data.tenant_config_action:type_name -> kms.api.cmk.eventprocessor.task.v1.TenantConfigAction
