...
const file_kms_api_cmk_sessionmanager_session_v1_session_proto_rawDesc = "" +
	"\n" +
	"3kms/api/cmk/sessionmanager/session/v1/session.proto\x12%kms.api.cmk.sessionmanager.session.v1\x1a kms/api/cmk/trust/v1/trust.proto\x1a\x1fkms/api/cmk/types/v1/oidc.proto\"u\n" +
	"\x11GetSessionRequest\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12\x1b\n" +
	"\ttenant_id\x18\x02 \x01(\tR\btenantId\x12$\n" +
	"\vfingerprint\x18\x03 \x01(\tB\x02\x18\x01R\vfingerprint\"\xf9\x02\n" +
