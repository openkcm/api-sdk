...
const (
	...
	Service_GetTenantConfig_FullMethodName     = "/kms.api.cmk.registry.tenant.v1.Service/GetTenantConfig"
	Service_UpdateTenantConfig_FullMethodName  = "/kms.api.cmk.registry.tenant.v1.Service/UpdateTenantConfig"
)
...
func (UnimplementedServiceServer) RemoveTenantLabels(context.Context, *RemoveTenantLabelsRequest) (*RemoveTenantLabelsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveTenantLabels not implemented")
}
func (UnimplementedServiceServer) SetTenantUserGroups(context.Context, *SetTenantUserGroupsRequest) (*SetTenantUserGroupsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetTenantUserGroups not implemented")
}
