...
// TenantConfiguration holds tenant-specific configuration settings.
...
const file_kms_api_cmk_registry_tenant_v1_tenant_proto_rawDesc = "" +
	...
	"\x06tenant\x18\x01 \x01(\v2&.kms.api.cmk.registry.tenant.v1.TenantR\x06tenant\"N\n" +
	...
	"\x1bACTION_UPDATE_TENANT_CONFIG\x10\x052\xbd\v\n" +
...
var file_kms_api_cmk_registry_tenant_v1_tenant_proto_goTypes = []any{
	...
	(*SetTenantUserGroupsRequest)(nil),  // 18: kms.api.cmk.registry.tenant.v1.SetTenantUserGroupsRequest
	(*SetTenantUserGroupsResponse)(nil), // 19: kms.api.cmk.registry.tenant.v1.SetTenantUserGroupsResponse
	...
	(*TenantConfiguration)(nil),         // 22: kms.api.cmk.registry.tenant.v1.TenantConfiguration
	(*GetTenantConfigRequest)(nil),      // 23: kms.api.cmk.registry.tenant.v1.GetTenantConfigRequest
	(*GetTenantConfigResponse)(nil),     // 24: kms.api.cmk.registry.tenant.v1.GetTenantConfigResponse
	(*UpdateTenantConfigRequest)(nil),   // 25: kms.api.cmk.registry.tenant.v1.UpdateTenantConfigRequest
	(*UpdateTenantConfigResponse)(nil),  // 26: kms.api.cmk.registry.tenant.v1.UpdateTenantConfigResponse
	nil,                                 // 27: kms.api.cmk.registry.tenant.v1.Tenant.LabelsEntry
	nil,                                 // 28: kms.api.cmk.registry.tenant.v1.RegisterTenantRequest.LabelsEntry
	nil,                                 // 29: kms.api.cmk.registry.tenant.v1.ListTenantsRequest.LabelsEntry
	nil,                                 // 30: kms.api.cmk.registry.tenant.v1.SetTenantLabelsRequest.LabelsEntry
...
var file_kms_api_cmk_registry_tenant_v1_tenant_proto_depIdxs = []int32{
	...
	27, // 2: kms.api.cmk.registry.tenant.v1.Tenant.labels:type_name -> kms.api.cmk.registry.tenant.v1.Tenant.LabelsEntry
	1,  // 3: kms.api.cmk.registry.tenant.v1.RegisterTenantRequest.role:type_name -> kms.api.cmk.registry.tenant.v1.Role
	28, // 4: kms.api.cmk.registry.tenant.v1.RegisterTenantRequest.labels:type_name -> kms.api.cmk.registry.tenant.v1.RegisterTenantRequest.LabelsEntry
	29, // 5: kms.api.cmk.registry.tenant.v1.ListTenantsRequest.labels:type_name -> kms.api.cmk.registry.tenant.v1.ListTenantsRequest.LabelsEntry
	3,  // 6: kms.api.cmk.registry.tenant.v1.ListTenantsResponse.tenants:type_name -> kms.api.cmk.registry.tenant.v1.Tenant
	30, // 7: kms.api.cmk.registry.tenant.v1.SetTenantLabelsRequest.labels:type_name -> kms.api.cmk.registry.tenant.v1.SetTenantLabelsRequest.LabelsEntry
	3,  // 8: kms.api.cmk.registry.tenant.v1.GetTenantResponse.tenant:type_name -> kms.api.cmk.registry.tenant.v1.Tenant
	22, // 9: kms.api.cmk.registry.tenant.v1.GetTenantConfigResponse.config:type_name -> kms.api.cmk.registry.tenant.v1.TenantConfiguration
	22, // 10: kms.api.cmk.registry.tenant.v1.UpdateTenantConfigRequest.config:type_name -> kms.api.cmk.registry.tenant.v1.TenantConfiguration
	31, // 11: kms.api.cmk.registry.tenant.v1.UpdateTenantConfigRequest.update_mask:type_name -> google.protobuf.FieldMask
	22, // 12: kms.api.cmk.registry.tenant.v1.UpdateTenantConfigResponse.config:type_name -> kms.api.cmk.registry.tenant.v1.TenantConfiguration
	4,  // 13: kms.api.cmk.registry.tenant.v1.Service.RegisterTenant:input_type -> kms.api.cmk.registry.tenant.v1.RegisterTenantRequest
	6,  // 14: kms.api.cmk.registry.tenant.v1.Service.ListTenants:input_type -> kms.api.cmk.registry.tenant.v1.ListTenantsRequest
	20, // 15: kms.api.cmk.registry.tenant.v1.Service.GetTenant:input_type -> kms.api.cmk.registry.tenant.v1.GetTenantRequest
	8,  // 16: kms.api.cmk.registry.tenant.v1.Service.BlockTenant:input_type -> kms.api.cmk.registry.tenant.v1.BlockTenantRequest
	10, // 17: kms.api.cmk.registry.tenant.v1.Service.UnblockTenant:input_type -> kms.api.cmk.registry.tenant.v1.UnblockTenantRequest
	12, // 18: kms.api.cmk.registry.tenant.v1.Service.TerminateTenant:input_type -> kms.api.cmk.registry.tenant.v1.TerminateTenantRequest
	14, // 19: kms.api.cmk.registry.tenant.v1.Service.SetTenantLabels:input_type -> kms.api.cmk.registry.tenant.v1.SetTenantLabelsRequest
	16, // 20: kms.api.cmk.registry.tenant.v1.Service.RemoveTenantLabels:input_type -> kms.api.cmk.registry.tenant.v1.RemoveTenantLabelsRequest
	18, // 21: kms.api.cmk.registry.tenant.v1.Service.SetTenantUserGroups:input_type -> kms.api.cmk.registry.tenant.v1.SetTenantUserGroupsRequest
	23, // 22: kms.api.cmk.registry.tenant.v1.Service.GetTenantConfig:input_type -> kms.api.cmk.registry.tenant.v1.GetTenantConfigRequest
	25, // 23: kms.api.cmk.registry.tenant.v1.Service.UpdateTenantConfig:input_type -> kms.api.cmk.registry.tenant.v1.UpdateTenantConfigRequest
	5,  // 24: kms.api.cmk.registry.tenant.v1.Service.RegisterTenant:output_type -> kms.api.cmk.registry.tenant.v1.RegisterTenantResponse
	7,  // 25: kms.api.cmk.registry.tenant.v1.Service.ListTenants:output_type -> kms.api.cmk.registry.tenant.v1.ListTenantsResponse
	21, // 26: kms.api.cmk.registry.tenant.v1.Service.GetTenant:output_type -> kms.api.cmk.registry.tenant.v1.GetTenantResponse
	9,  // 27: kms.api.cmk.registry.tenant.v1.Service.BlockTenant:output_type -> kms.api.cmk.registry.tenant.v1.BlockTenantResponse
	11, // 28: kms.api.cmk.registry.tenant.v1.Service.UnblockTenant:output_type -> kms.api.cmk.registry.tenant.v1.UnblockTenantResponse
	13, // 29: kms.api.cmk.registry.tenant.v1.Service.TerminateTenant:output_type -> kms.api.cmk.registry.tenant.v1.TerminateTenantResponse
	15, // 30: kms.api.cmk.registry.tenant.v1.Service.SetTenantLabels:output_type -> kms.api.cmk.registry.tenant.v1.SetTenantLabelsResponse
	17, // 31: kms.api.cmk.registry.tenant.v1.Service.RemoveTenantLabels:output_type -> kms.api.cmk.registry.tenant.v1.RemoveTenantLabelsResponse
	19, // 32: kms.api.cmk.registry.tenant.v1.Service.SetTenantUserGroups:output_type -> kms.api.cmk.registry.tenant.v1.SetTenantUserGroupsResponse
	24, // 33: kms.api.cmk.registry.tenant.v1.Service.GetTenantConfig:output_type -> kms.api.cmk.registry.tenant.v1.GetTenantConfigResponse
	26, // 34: kms.api.cmk.registry.tenant.v1.Service.UpdateTenantConfig:output_type -> kms.api.cmk.registry.tenant.v1.UpdateTenantConfigResponse
